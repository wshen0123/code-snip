...
{
	fprint_offset_hex(stdout, data, len);
}
...
main(int argc, char *argv[])
{
	...
	int n80211HeaderLength, nLinkEncap;
	...
	switch (nLinkEncap) {
		...
		case DLT_IEEE802_11_RADIO:
			...
			/* note: BPF would mangle radiotap header, only keeps Rate Info */
//			szProgram = "ether[0x0a:4]==0x13223344";
			szProgram = "ether src 13:22:33:44:55:66";
			break;
	...
	while (!fBrokenSocket) {
		...
		print_offset_hex(pu8Payload, ppcapPacketHeader->len);
